...
const members: Array<[string, string]> = [
  ['सौ. मीरा देशपांडे', '/assets/family-1-opt.webp'],
  ['श्री. अमित देशपांडे', '/assets/family-2-opt.webp'],
  ['कु. अनन्या देशपांडे', '/assets/family-3-opt.webp'],
  ['चि. आरव देशपांडे', '/assets/family-4-opt.webp'],
]
            ...
            <div className="location-card">
              ...
              <div className="location-content">
                ...
                <p className="location-address">
                  फ्लॅट नं. ४०२,<br />
                  देशपांडे सदन, दादर, मुंबई<br />
                  महाराष्ट्र - ४०००२८
                </p>
                <a className="maps-button" href="https://maps.google.com/?q=Dadar,Mumbai,Maharashtra" target="_blank" rel="noreferrer">
                  Open Maps <span>↗</span>
                </a>
